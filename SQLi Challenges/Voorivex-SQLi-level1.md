...
**First thing that you see when opening the site and it attracts your attention is this -> ***URL: XYZ.onlin/post.php?id=1*****
...
**We broke the SQL query now we need to fix it. let's try ***URL: XYZ.onlin/post.php?id=1'+--+-***, its worked:**
